...
IFontDisp = Font
__all__ = [ 'FONTITALIC', 'OLE_XPOS_PIXELS', 'FONTNAME', 'FONTSIZE',
           'OLE_XSIZE_CONTAINER', 'OLE_XSIZE_HIMETRIC',
           'OLE_TRISTATE', 'LoadPictureConstants', 'StdFont',
           'OLE_YPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'StdPicture',
           'Monochrome', 'OLE_COLOR', 'Picture', 'OLE_YSIZE_HIMETRIC',
           'IFontDisp', 'FONTBOLD', 'IFontEventsDisp', 'Unchecked',
           'IFont', 'OLE_XPOS_CONTAINER', 'Gray', 'FontEvents',
           'IPicture', 'IPictureDisp', 'OLE_YPOS_CONTAINER',
           'Default', 'OLE_CANCELBOOL', 'Checked',
           'OLE_YSIZE_CONTAINER', 'OLE_ENABLEDEFAULTBOOL', 'VgaColor',
           'Color', 'OLE_YPOS_PIXELS', 'FONTUNDERSCORE', 'Font',
           'OLE_XPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE',
           'OLE_XSIZE_PIXELS', 'OLE_HANDLE', 'FONTSTRIKETHROUGH']
